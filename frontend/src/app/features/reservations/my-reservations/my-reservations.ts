...
export class MyReservationsComponent implements OnInit {
  ...
  loadReservations(): void {
    ...
    // Type 'beneficiary' pour les réservations faites par l'utilisateur
    this.reservationService.getMyReservations('beneficiary').subscribe({
      next: (response) => {
        console.log('📋 My Reservations:', response);
  ...
  cancelReservation(reservationId: string): void {
    ...
    this.reservationService.cancelReservation(reservationId, 'Annulée par le bénéficiaire').subscribe({
      next: (response) => {
